...
function generatePassword() {
  ...
  if (charLength < 8 || charLength > 128) {
    ...
    if (charactersLowercase == true) {
      ...
      password += lowercaseArr[Math.floor(Math.random() * lowercaseArr.length)]
    ...
    if (charactersUppercase == true) {
      ...
      console.log(allChars);
      password += UppercaseArr[Math.floor(Math.random() * UppercaseArr.length)]
    }
    // prompt for nums?
    ...
    if (characternumb ==  true) {
      ...
      password += numbArr[Math.floor(Math.random() * numbArr.length)]
    ...
    if (charactersymbol == true) {
      ...
      password += symbolArr[Math.floor(Math.random() * symbolArr.length)]
